...
import DaftarSiswaJadwalModal from './DaftarSiswaJadwalModal'
...
const JadwalDetailDrawer = ({ open, jadwal, onClose, onRefresh }: JadwalDetailDrawerProps) => {
            ...
            >
                <div className="px-4 pt-4 pb-6 flex flex-col gap-3">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800 rounded-xl px-3">
                        ...
                        />
                        <DetailRow icon={<HiOutlineTag />} label="Kategori Umur" value={jadwal.nama_kategori_umur} />
                    </div>
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <p className="text-sm font-semibold text-gray-700 dark:text-gray-200">Siswa di Kelas</p>
                            {!loadingSiswa && (
                                <span className="text-xs text-gray-400">{siswaList.length} siswa</span>
                            )}
                            <Button
                                className="ml-auto"
                                size="xs"
